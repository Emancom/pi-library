# Traceability Audit Report: Oral rehydration salts
...
1. [6. Adverse Effects] Adverse reactions in ESRD patients are often confounded by the underlying pathology. Data from double-blind, placebo-controlled trials indicate the following (frequencies based on [US] data):
