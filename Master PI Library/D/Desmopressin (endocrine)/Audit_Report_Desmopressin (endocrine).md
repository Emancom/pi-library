# Traceability Audit Report: Desmopressin (endocrine)
...
1. [6. Adverse Effects] Adverse effects listed reflect data from clinical trials in ESRD patients [US].
2. [6. Adverse Effects] *Note: In ESRD populations, many adverse events are confounded by the underlying pathology.*
