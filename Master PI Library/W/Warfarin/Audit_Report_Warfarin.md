# Traceability Audit Report: Warfarin
...
1. [2. Approved Indications] Based on available sources, warfarin is indicated for:
2. [4. Contraindications] Warfarin is contraindicated in the following scenarios [Australian]:
