# Traceability Audit Report: Periciazine
...
1. [6. Adverse Effects] Adverse reactions are common in the ESRD population due to underlying pathology; however, the following have been reported in clinical trials (≥5% frequency):
