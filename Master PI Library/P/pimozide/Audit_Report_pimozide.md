# Traceability Audit Report: pimozide
...
1. [3. Dosage and Administration] Dosing requires slow titration to balance tic suppression against adverse effects. A gradual withdrawal is recommended when discontinuing therapy [US].
