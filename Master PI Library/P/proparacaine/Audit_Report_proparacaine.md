# Traceability Audit Report: proparacaine
...
1. [6. Adverse Effects] The following adverse effects have been reported; however, specific frequency data (e.g., % incidence) is not specified in available sources.
