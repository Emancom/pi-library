# Traceability Audit Report: Prazosin
...
1. [3. Dosage and Administration] Therapy should be initiated at a low dose to enhance patient tolerability. Doses should be titrated based on the individual patient’s blood pressure and clinical response.
