# Traceability Audit Report: Prednisolone (eye)
...
1. [6. Adverse Effects] Adverse effects are often confounded by the underlying pathology (e.g., ESRD or metabolic crisis).
