# Traceability Audit Report: Polio vaccine (child)
...
1. [6. Adverse Effects] Adverse events reported in double-blind, placebo-controlled trials for ESRD patients (occurring at ≥5% frequency) include:
