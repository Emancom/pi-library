# Traceability Audit Report: Phenylephrine (parenteral)
...
1. [6. Adverse Effects] Adverse events reported in clinical trials for ESRD patients (frequency ≥5% regardless of causality) include:
