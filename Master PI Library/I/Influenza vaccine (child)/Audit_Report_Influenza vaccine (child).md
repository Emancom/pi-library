# Traceability Audit Report: Influenza vaccine (child)
...
1. [6. Adverse Effects] Adverse effects are categorised by frequency where data is available from clinical trials in ESRD patients.
