# Traceability Audit Report: Ketotifen
...
1. [6. Adverse Effects] Adverse reactions are ranked by frequency according to the following convention: Very common ($\ge$10%); Common ($\ge$1% to <10%); Uncommon ($\ge$0.1% to <1%).
