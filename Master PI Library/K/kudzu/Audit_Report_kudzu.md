# Traceability Audit Report: kudzu
...
1. [6. Adverse Effects] Adverse reactions are frequently confounded by the underlying pathology of ESRD or metabolic disorders. The following frequencies are based on clinical trials in ESRD patients [US]:
