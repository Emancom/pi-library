# Traceability Audit Report: zebinix
...
1. [6. Adverse Effects] Adverse effects vary by population. In ESRD patients, distinguishing drug effects from the underlying pathology can be difficult.
