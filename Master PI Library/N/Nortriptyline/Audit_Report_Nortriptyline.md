# Traceability Audit Report: Nortriptyline
...
1. [6. Adverse Effects] Adverse effects common to the tricyclic antidepressant class should be considered even if not specifically reported for nortriptyline.
