# Traceability Audit Report: radioactive iodine
...
1. [6. Adverse Effects] Adverse events observed in clinical trials (ESRD patients on dialysis) with a frequency ≥5% (regardless of causality) include:
