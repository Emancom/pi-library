# Traceability Audit Report: thiethylperazine
...
1. [6. Adverse Effects] Adverse event profiles vary significantly based on the underlying pathology (ESRD vs. metabolic disorders).
2. [6. Adverse Effects] Common adverse effects (≥5%) reported in placebo-controlled trials [US]:
