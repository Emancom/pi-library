# Traceability Audit Report: trioxysalen
...
1. [6. Adverse Effects] Adverse events reported in double-blind, placebo-controlled trials for ESRD patients (regardless of causality) include:
