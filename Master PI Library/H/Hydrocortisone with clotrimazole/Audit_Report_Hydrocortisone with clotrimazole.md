# Traceability Audit Report: Hydrocortisone with clotrimazole
...
1. [6. Adverse Effects] Adverse events reported in clinical trials (≥5% frequency) regardless of causality include:
