# Traceability Audit Report: cimetidine
...
1. [6. Adverse Effects] *Note: The available source focuses on OTC labeling; detailed frequency data for common adverse effects are not provided in the source document.*
