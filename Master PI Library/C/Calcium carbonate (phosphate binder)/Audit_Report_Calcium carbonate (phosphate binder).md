# Traceability Audit Report: Calcium carbonate (phosphate binder)
...
1. [6. Adverse Effects] Adverse events observed in clinical trials for ESRD patients (occurring at ≥5% frequency) include:
