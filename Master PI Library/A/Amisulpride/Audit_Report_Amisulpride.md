# Traceability Audit Report: Amisulpride
...
1. [6. Adverse Effects] Adverse effect frequencies are categorized as: Very common (≥10%), Common (1–10%), Uncommon (0.1–1%), Rare (<0.1%).
