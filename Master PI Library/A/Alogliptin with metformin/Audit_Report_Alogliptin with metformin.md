# Traceability Audit Report: Alogliptin with metformin
...
1. [6. Adverse Effects] Adverse reactions are often confounded by the underlying pathology (ESRD or metabolic disease). Frequencies below are derived from clinical trials in ESRD patients [US].
