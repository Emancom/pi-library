# Traceability Audit Report: Antithymocyte globulins
...
1. [6. Adverse Effects] Adverse effects observed in clinical trials (specifically in ESRD patients on hemodialysis) with a frequency ≥5% include:
