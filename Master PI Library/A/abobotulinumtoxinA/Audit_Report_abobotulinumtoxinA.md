# Traceability Audit Report: abobotulinumtoxinA
...
1. [6. Adverse Effects] Adverse events observed in clinical trials (ESRD patients) with a frequency ≥5% (regardless of causality) include [US]:
