# Traceability Audit Report: Amphotericin B
...
1. [2. Approved Indications] **AmBisome** is indicated for:
2. [6. Adverse Effects] Adverse effect frequencies are based on clinical trial data (N=834) [Australian].
