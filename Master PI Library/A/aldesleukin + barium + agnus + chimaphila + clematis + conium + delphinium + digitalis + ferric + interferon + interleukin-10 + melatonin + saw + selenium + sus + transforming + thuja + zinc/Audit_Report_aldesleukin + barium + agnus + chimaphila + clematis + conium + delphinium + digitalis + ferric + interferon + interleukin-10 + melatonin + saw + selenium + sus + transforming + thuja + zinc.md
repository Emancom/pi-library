# Traceability Audit Report: aldesleukin + barium + agnus + chimaphila + clematis + conium + delphinium + digitalis + ferric + interferon + interleukin-10 + melatonin + saw + selenium + sus + transforming + thuja + zinc
...
1. [7. Adverse Effects] Adverse effects table (as reported / not reported in source materials)
