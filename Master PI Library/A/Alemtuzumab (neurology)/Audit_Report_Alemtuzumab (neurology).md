# Traceability Audit Report: Alemtuzumab (neurology)
...
1. [6. Adverse Effects] Adverse effect profiles differ significantly based on the underlying pathology (metabolic vs. ESRD).
