# Traceability Audit Report: Estradiol with dienogest
...
1. [6. Adverse Effects] Adverse events occurring at a frequency $\geq 5\%$ in double-blind, placebo-controlled trials (regardless of causality) include:
