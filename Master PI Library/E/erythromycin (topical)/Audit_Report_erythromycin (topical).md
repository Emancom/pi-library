# Traceability Audit Report: erythromycin (topical)
...
1. [6. Adverse Effects] The following local adverse reactions have been reported; however, specific frequency data (e.g., %) was not provided in the source documentation.
