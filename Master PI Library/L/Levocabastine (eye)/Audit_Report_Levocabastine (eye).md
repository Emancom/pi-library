# Traceability Audit Report: Levocabastine (eye)
...
1. [6. Adverse Effects] Adverse effects are categorised by frequency based on clinical trials in ESRD patients on hemodialysis.
