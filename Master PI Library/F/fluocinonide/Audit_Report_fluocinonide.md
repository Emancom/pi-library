# Traceability Audit Report: fluocinonide
...
1. [6. Adverse Effects] The following local adverse reactions are reported infrequently but may increase in frequency with the use of occlusive dressings [US]. Frequencies are not specified in available sources, but are list
