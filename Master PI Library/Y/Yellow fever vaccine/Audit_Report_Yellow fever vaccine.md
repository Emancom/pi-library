# Traceability Audit Report: Yellow fever vaccine
...
1. [6. Adverse Effects] Adverse effects are often confounded by the underlying pathology of the patient populations (ESRD or metabolic errors).
