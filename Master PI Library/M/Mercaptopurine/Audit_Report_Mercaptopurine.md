# Traceability Audit Report: Mercaptopurine
...
1. [2. Approved Indications] *Note: The specific formulation (ALLMERCAP) provided in the source is only indicated for use in children [Australian].*
2. [6. Adverse Effects] Adverse effects are categorized by frequency below [Australian]:
