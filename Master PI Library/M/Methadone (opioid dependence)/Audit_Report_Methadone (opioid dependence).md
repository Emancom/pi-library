# Traceability Audit Report: Methadone (opioid dependence)
...
1. [6. Adverse Effects] Adverse events reported in clinical trials (ESRD patients on hemodialysis) with a frequency ≥5%, regardless of causality, include:
