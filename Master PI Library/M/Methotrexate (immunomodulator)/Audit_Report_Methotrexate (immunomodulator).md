# Traceability Audit Report: Methotrexate (immunomodulator)
...
1. [6. Adverse Effects] Adverse event data from clinical trials in ESRD patients undergoing chronic hemodialysis (incidence ≥5%):
