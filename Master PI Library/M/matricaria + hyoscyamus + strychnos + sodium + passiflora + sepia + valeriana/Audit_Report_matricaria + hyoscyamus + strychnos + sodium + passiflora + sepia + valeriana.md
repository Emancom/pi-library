# Traceability Audit Report: matricaria + hyoscyamus + strychnos + sodium + passiflora + sepia + valeriana
...
1. [7. Adverse Effects] Adverse effects by system organ class and frequency (as reported in available sources)
